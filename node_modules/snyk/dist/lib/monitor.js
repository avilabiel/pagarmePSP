...
function monitorGraph(root, meta, info, targetFile) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (meta.prune) {
            ...
            prunedGraph = yield pruneGraph(depGraph, packageManager);
        }
        return new Promise((resolve, reject) => {
            request({
                body: {
...
function pruneGraph(depGraph, packageManager) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const prunedTree = (yield depGraphLib.legacy.graphToDepTree(depGraph, packageManager, { deduplicateWithinTopLevelDeps: true }));
            const prunedGraph = yield depGraphLib.legacy.depTreeToGraph(prunedTree, packageManager);
